...
class TestTile(TestCase):
    ...
    def test_tile_ordering(self):
        hand1 = tile.tile_set_from_string("123456789m123456789s123456789p1234567z")
        assert sorted(hand1.keys()) == list(tile.tile_set_from_string("123456789m123456789p123456789s1234567z").keys())
